# Team Management Card Creation [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

## Description

The purpose to create an employee card to manage and maintain on employees.
...
You will need to install inquirer, and fs to make the program function properly.

## Usage

by typing node index in the correct terminal you will get an output return of questions to help create and organize the employees information.
